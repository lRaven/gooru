<template>
	<svg
		...
		class="icon"
	>
		<path d="M5 9V7H7V9H5Z" fill="#fff" fill-opacity="0.5" />
		<path d="M9 9H19V7H9V9Z" fill="#fff" fill-opacity="0.5" />
		<path d="M5 15V17H7V15H5Z" fill="#fff" fill-opacity="0.5" />
		<path d="M19 17H9V15H19V17Z" fill="#fff" fill-opacity="0.5" />
		<path
			fill-rule="evenodd"
			clip-rule="evenodd"
