    ...
    <div class="rates-slider">
      <div class="rates-slider__top">
        ...
        <div class="rates-slider__nav" v-show="document_width > 540">
          <button class="rates-slider-button-prev swiper-button-prev"></button>
          <button class="rates-slider-button-next swiper-button-next"></button>
        </div>
      </div>
      <swiper
...
<rate-popup v-else :selectedRate="selectedRate" @closePopup="selectedRate = null"/>
</template>
