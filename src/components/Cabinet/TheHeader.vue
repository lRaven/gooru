		...
		<div class="the-header__col">
			...
			<div class="the-header__account" v-click-away="closeProfile">
				...
				<transition>
					...
					>
						<li class="the-header__account-content-item">
							<div
								class="the-header__account-content-icon-wrapper"
							>
								<svg
									width="32"
									height="32"
									...
									class="the-header__account-content-icon"
								>
									<path
							...
							<p class="the-header__account-content-description">
								Мой профиль
							</p>
						</li>
						<li class="the-header__account-content-item">
