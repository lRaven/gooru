	...
	<li class="favorite-content-item" v-click-away="stateReset">
		...
		>
			<div
				...
				class="favorite-content-item__comment"
			>
				<p class="favorite-content-item__comment-subtitle">
					Комментарий:
				</p>
				<p class="favorite-content-item__comment-text">
					{{ parser.comment.text }}
				</p>
				<div class="favorite-content-item__controls">
					<svg
						class="favorite-content-item__control-edit-button"
					...
					<svg
						class="favorite-content-item__control-remove-button"
