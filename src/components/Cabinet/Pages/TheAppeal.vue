  ...
  >
    <div class="the-appeal__main">
      ...
      <div class="the-appeal__header">
        ...
        <p class="the-appeal__source">
          {{ appeal_source }}
        </p>
        <p class="the-appeal__topic">
          {{ appeal_topic }}
        </p>
        <p class="the-appeal__topic-message">
          {{ appeal.message }}
        </p>
      </div>
...
export default {
  ...
  computed: {
    ...
    appeal_source() {
      ...
      const find = this.all_parsers.find((el) => el.id === this.appeal.id);
      if (find !== undefined) {
        result = find.title;
      }
    ...
    appeal_topic() {
      ...
      const find = this.topics.find((el) => el.id === this.appeal.topic_type);
      if (find !== undefined) {
  ...
  methods: {
    ...
    validateForm() {
      if (this.new_appeal.topic !== "" && this.new_appeal.message.length > 0) {
